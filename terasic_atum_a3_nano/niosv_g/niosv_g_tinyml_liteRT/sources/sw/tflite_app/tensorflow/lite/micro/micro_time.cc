...
extern "C" int alt_timestamp_start();
extern "C" int alt_timestamp();
extern "C" int alt_timestamp_freq();
...
uint32_t ticks_per_second() { return alt_timestamp_freq(); }
...
uint32_t GetCurrentTimeTicks() { return alt_timestamp();}
#endif
