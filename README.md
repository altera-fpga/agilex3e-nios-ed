...
| 23| Nios V/g | Nios V/g Baseline Design| This design demonstrates the Baseline Design for a Nios® V/g processor with basic bare minimum peripherals required for any application execution <br>[Design details](terasic_atum_a3_nano/niosv_g/niosv_g_baseline_design/docs/Niosv_g_Processor_Baseline_Design_on_Atum_A3_Nano_FPGA.md) |
